  ...
  <body>
    ...
    <header id="slider-area">  
      <nav class="navbar navbar-expand-md fixed-top scrolling-navbar bg-white">
        <div class="container">          
          <a class="navbar-brand" href="{{ url('/') }}"><span class="lni-bulb"></span>IT WAY UK</a>
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption text-left">
                <h3 class="wow fadeInRight" data-wow-delay="0.2s">Fly High</h1>  
                <h2 class="wow fadeInRight" data-wow-delay="0.4s">Get long flight trips</h2>
                <h4 class="wow fadeInRight" data-wow-delay="0.6s">Our priority is your safety</h4>
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption text-center">
                <h3 class="wow fadeInDown" data-wow-delay="0.3s">Business</h3>
                <h2 class="wow bounceIn" data-wow-delay="0.6s">Control Panel</h2> 
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption text-center">
                ...
                <h2 class="wow fadeInRight" data-wow-delay="0.6s">Buy new cars</h2> 
                <h4 class="wow fadeInUp" data-wow-delay="0.6s">Safe and secure trips</h4>
